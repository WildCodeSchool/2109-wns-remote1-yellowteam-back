...
export class ProjectTasksArgs {
  ...
  distinct?: Array<"id" | "title" | "description" | "private" | "is_disabled" | "status_task" | "total_time_spent" | "start_date" | "end_date" | "userId" | "projectId" | "created_at" | "updated_at"> | undefined;
}
