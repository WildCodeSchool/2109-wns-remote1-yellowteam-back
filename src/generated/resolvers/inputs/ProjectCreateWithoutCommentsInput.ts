...
import { FileCreateNestedManyWithoutProjectInput } from "./FileCreateNestedManyWithoutProjectInput";
...
@TypeGraphQL.InputType("ProjectCreateWithoutCommentsInput", {
  isAbstract: true
})
export class ProjectCreateWithoutCommentsInput {
