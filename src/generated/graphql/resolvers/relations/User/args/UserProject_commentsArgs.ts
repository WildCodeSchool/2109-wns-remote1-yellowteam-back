...
export class UserProject_commentsArgs {
  ...
  distinct?: Array<"id" | "is_disabled" | "content" | "task_comment_user_id" | "project_id" | "task_id" | "project_comment_user_id" | "created_at" | "updated_at"> | undefined;
}
