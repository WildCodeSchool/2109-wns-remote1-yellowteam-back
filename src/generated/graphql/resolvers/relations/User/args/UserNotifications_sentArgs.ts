...
export class UserNotifications_sentArgs {
  ...
  distinct?: Array<"id" | "is_disabled" | "title" | "content" | "user_id" | "type" | "status" | "reference_id" | "sender_id" | "created_at" | "updated_at"> | undefined;
}
